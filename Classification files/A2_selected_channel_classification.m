...
TRN(:,:)=cat(3,trn(1,:,:),trn(3,:,:),trn(6,:,:),trn(12,:,:),trn(7,:,:),trn(17,:,:),trn(19,:,:),trn(11,:,:),trn(14,:,:),trn(18,:,:),trn(21,:,:),trn(28,:,:),trn(30,:,:));
TST(:,:)=cat(3,tst(1,:,:),tst(3,:,:),tst(6,:,:),tst(12,:,:),tst(7,:,:),tst(17,:,:),tst(19,:,:),tst(11,:,:),tst(14,:,:),tst(18,:,:),tst(21,:,:),tst(28,:,:),tst(30,:,:));

mdl=fitcsvm(TRN,trnL);
O=predict(mdl,TST);
...
TRN(:,:)=cat(3,trn(16,:,:),trn(21,:,:),trn(24,:,:),trn(14,:,:),trn(19,:,:),trn(9,:,:),trn(7,:,:),trn(12,:,:),trn(13,:,:),trn(26,:,:),trn(29,:,:));
TST(:,:)=cat(3,tst(16,:,:),tst(21,:,:),tst(24,:,:),tst(14,:,:),tst(19,:,:),tst(9,:,:),tst(7,:,:),tst(12,:,:),tst(13,:,:),tst(26,:,:),tst(29,:,:));
...
TRN(:,:)=cat(3,trn(1,:,:),trn(2,:,:),trn(16,:,:),trn(3,:,:),trn(7,:,:),trn(12,:,:),trn(14,:,:),trn(17,:,:),trn(20,:,:));
TST(:,:)=cat(3,tst(1,:,:),tst(2,:,:),tst(16,:,:),tst(3,:,:),tst(7,:,:),tst(12,:,:),tst(14,:,:),tst(17,:,:),tst(20,:,:));
